...
public class ZhenduanjiluController {
    ...
    public R page(@RequestParam Map<String, Object> params,ZhenduanjiluEntity zhenduanjilu,
		...
		if(tableName.equals("huanzhe")) {
			zhenduanjilu.setHuanzhezhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yisheng")) {
			zhenduanjilu.setYishenggonghao((String)request.getSession().getAttribute("username"));
		}
